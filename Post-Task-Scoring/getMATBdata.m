function [rate_data, sysmon_data, track_data, comm_data, resman_data, matb_data] = getMATBdata(date_time, subject_folder, data_folder)
...
fid = fopen(fullfile('..\',data_folder,subject_folder,matb_file));
